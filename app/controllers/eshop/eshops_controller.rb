class Eshop::EshopsController < ApplicationController
...
before_action :configure_permitted_parameters, if: :devise_controller?
  ...
  def index
    ...
    $eshops = $prefec.eshops.all
    render :layout => "app2"
  end

  def show
    $eshop = $prefec.eshops.where(:id => params[:id]).first
