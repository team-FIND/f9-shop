class Fsearch::FsshopsController < ApplicationController
...
before_action :configure_permitted_parameters, if: :devise_controller?
  ...
  def index
    $search = Fshop.search(params[:q])
    $fshops = $search.result
    render :layout => "app2"
  end
