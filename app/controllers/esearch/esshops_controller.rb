class Esearch::EsshopsController < ApplicationController
...
before_action :configure_permitted_parameters, if: :devise_controller?
  ...
  def index
    $search = Eshop.search(params[:q])
    $eshops = $search.result
    render :layout => "app2"
  end
