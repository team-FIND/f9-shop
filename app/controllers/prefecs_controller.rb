class PrefecsController < ApplicationController
  ...
  private
    ...
    def prefec_params
      params.require(:prefec).permit(:area_id, :name, :citytop_img, :citytop_name, :newshop_img1, :newshop_name1, :newshop_img2, :newshop_name2, :newshop_img3, :newshop_name3, :newshop_img4, :newshop_name4, :newshop_img5, :newshop_name5, :newshop_img6, :newshop_name6, :newshop_img7, :newshop_name7, :newshop_img8, :newshop_name8, :newshop_img9, :newshop_name9, :newshop_img10, :newshop_name10, :newshop_url1, :newshop_url2, :newshop_url3, :newshop_url4, :newshop_url5, :newshop_url6, :newshop_url7, :newshop_url8, :newshop_url9, :newshop_url10, :adshop_name1, :adshop_name2, :adshop_name3, :adshop_name4, :adshop_name5, :adshop_name6, :adshop_name7, :adshop_name8, :adshop_name9, :adshop_name10, :adshop_img1, :adshop_img2, :adshop_img3, :adshop_img4, :adshop_img5, :adshop_img6, :adshop_img7, :adshop_img8, :adshop_img9, :adshop_img10, :adshop_url1, :adshop_url2, :adshop_url3, :adshop_url4, :adshop_url5, :adshop_url6, :adshop_url7, :adshop_url8, :adshop_url9, :adshop_url10 )
    end
end
